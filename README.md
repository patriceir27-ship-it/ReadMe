...
### **Machine Learning**
✔ Linear/Logistic Regression, SVM, Trees, RF, XGBoost  
✔ Clustering (K-Means, Bisecting), PCA  
...
✔ PySpark, Spark MLlib  
✔ ETL Pipelines  
✔ Parquet, Delta, Partitioning  
✔ Cloud Data (AWS, GCP – fundamentals)
